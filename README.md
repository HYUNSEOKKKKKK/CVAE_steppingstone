...
This repository contains a Conditional Variational Autoencoder (CVAE) model designed to learn and generate stepping-stone sequences for footstep planning research.  
...
conda activate cvae_steppingstone
```
